...
const Port = () => {
  return (
    <div className="max-w-full w-full bg-[#131314]">
      ...
      <div className="max-w-[1200px] w-full flex flex-col items-start justify-center mx-auto py-20">
        ...
        <div className="w-full pt-8">
          <div className="w-full h-[400px] flex">
            <div
              className="w-1/2 h-full p-5 bg-transparent flex relative cursor-pointer rounded-2xl"
              id="CardHover"
            >
              ...
              <div
                className="w-full h-full absolute z-10 top-0 rounded-2xl left-0"
                id="CardHover"
              ></div>
            </div>
            <div className="w-1/2 grid z-10 grid-cols-2 gap-6 ml-[24px] h-full">
              <div
                className="w-[270px] h-[180px] cursor-pointer p-5 relative rounded-lg"
                id="CardHover"
              >
                <div className="absolute z-[5]">
                ...
                <div
                  className="w-full h-full absolute z-10 top-0 left-0 rounded-xl"
                  id="CardHover"
                ></div>
              </div>
              <div
                className="w-[270px] h-[180px] cursor-pointer p-5 rounded-xl relative"
                id="CardHover"
              >
                <div className="absolute z-[5]">
                  <h2 className="lg:text-2xl lg:leading-[49px] lg:mb-[6px] !leading-[120%] text-white text-sm sm:text-base md:text-2xl sm:leading-[22px] font-bold !mb-1 line-clamp-3">
                ...
                <div
                  className="w-full h-full absolute rounded-xl z-10 top-0 left-0"
                  id="CardHover"
                ></div>
              </div>
              <div
                className="w-[270px] h-[180px] cursor-pointer p-5 relative rounded-xl"
                id="CardHover"
              >
                <div className="absolute z-[5]">
                  <h2 className="lg:text-2xl lg:leading-[49px] lg:mb-[6px] !leading-[120%] text-white text-sm sm:text-base md:text-2xl sm:leading-[22px] font-bold !mb-1 line-clamp-3">
              ...
              >
                ...
                <div
                  className="w-full h-full absolute z-10 rounded-xl top-0 left-0"
                  id="CardHover"
                ></div>
              </div>
            </div>
          ...
          <div className="w-full h-[400px] flex mt-6">
            ...
            <div
              className="w-1/2 h-full ml-6 p-5 bg-transparent flex relative cursor-pointer rounded-2xl"
              id="CardHover"
            >
              <div className="absolute z-[5]">
                <h2 className="lg:text-[38px] lg:leading-[45px] lg:mb-2 !leading-[120%] text-white text-sm sm:text-base md:text-2xl sm:leading-[22px] font-bold !mb-1 line-clamp-3">
        ...
        <div className="hover:bg-[#00ad9c] rounded-lg cursor-pointer mt-8 group bg-[#319188] border-[#319188] border-2 flex items-center gap-3 py-3 px-5">
